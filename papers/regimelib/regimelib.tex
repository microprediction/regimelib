...
American options with switching in \citet{buffington2002}. \citet{yin2009option} expanded the coupled
Black--Scholes equations in the holding time of a fast chain, with the averaged volatility at leading order and
uniform error bounds; the general theory of two-time-scale Markov chains, forward and backward equations without
a potential term, is \citet{yin2013} and \citet{yin2009backward}; and the parallel expansion for fast stochastic
volatility, with a chain among the admissible drivers, is \citet{sircar1999}.
...
time $\tau/\eps$. The construction is standard singular perturbation \citep{yin2013}; the potential term $\diag g$ is what
